            ...
            <header class="container my-5">
                <nav class="row align-items-center py-2">
                    <a href="<?php the_url('/'); ?>" class="col-md d-flex align-items-center mb-3 mb-md-0">
                        <img width="70" class="mr-2" src="<?php echo BASE_IMAGE_PATH; ?>medal-logo.png" alt="トークアバウトごーるどめだる　サイトロゴ">
                        <span class="h2 font-weight-bold mb-0">トークアバウトごーるどめだる</span>
                    </a>
