...
--DROP DATABASE IF EXISTS goldmedal;
CREATE DATABASE goldmedal DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE goldmedal;

/* ユーザーに権限の付与 */
CREATE USER IF NOT EXISTS 'test_user'@'localhost' IDENTIFIED BY 'pwd';
GRANT ALL ON goldmedal.* TO 'test_user'@'localhost';
